...
<body>
 <div class="wrap" >
 	<div id="formulaire" >
       ...
       <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" placeholder="Entrez votre nom" name="nom"  autofocus></td><td></td></tr>
       <tr><td width="300x" align="center" ><span>Prenom</span></td>
       <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" placeholder="Entrez votre prenom" name="prenom"></td><td></td></tr>
       <tr><td width="300x" align="center" ><span>Date de naissance</span></td>
       <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" name="date"></td><td></td></tr>
           <tr>

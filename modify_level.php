...
window.onload = function(){ setInterval(textClignotant, 1000); };
			...
			<tr>
	          ...
	          <a href="form_ajout_etude.php">-Ajout</a><br>
	          </div><div class='wifeo_pagemenu'>
	         <a href="form_recherche_etude.php">-Recherche</a><br>
	          </div></div></nav>
	           <h3><u>Gestion étudiant</u></h3>
	           <nav><div class='wifeo_conteneur_menu'><div class='wifeo_pagemenu'>
	          <a href="form_ajout_etudiant.php">-Ajout</a><br>
	          </div><div class='wifeo_pagemenu'>
	         <a href="form_recherche_etudiant.php">-Recherche</a><br>
	          </div>
	          </div>
	          </nav>
				</td>
				<td align="center" ><h2><marquee>Rechercher un niveau d'étude</marquee></h2>
				
					 <?php include "modifier_etude.php"; ?>

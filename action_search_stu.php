...
window.onload = function(){ setInterval(textClignotant, 1000); };
			...
			<tr>
	         ...
	         <a href="search_stu.php">-Recherche</a><br>
				...
				<td align="center" ><h2><marquee>Vous pouvez ajouter un etudiant dans ce rubrique</marquee></h2>
				<div style="overflow:scroll; height:300px; border:#000000 0 solid; background:#F9F9F9; " >
				<?php include "action_form_recherche_etudiant_new.php"; ?>
			    </div>
				</td>
			</tr>
			<tr>

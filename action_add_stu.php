...
window.onload = function(){ setInterval(textClignotant, 1000); };
			...
			<tr>
	         ...
	         <a href="search_stu.php">-Recherche</a><br>
				...
				<td align="center" ><h2><marquee>Les informations de cet etudiant sont envoyes <img src="image/5.gif" width="50px" height="50px" > </marquee></h2>
				<div style="overflow:scroll; height:300px; border:#000000 0 solid;" >
					 <?php include "action_form_ajout_etudiant.php"; ?>
			   </div>
				</td>
			</tr>
			<tr>

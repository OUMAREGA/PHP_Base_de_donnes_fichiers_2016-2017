		...
		<table border="1" width="980px" >
			<tr>
				<td colspan="2" height="75px" align="center">
					...
					<p>
						<h2>MINI LOGICIEL DE GESTION DES ETUDIANTS</h2>
					</p>
				</span>
...
window.onload = function(){ setInterval(textClignotant, 1000); };
			...
			<tr>
				...
				<h3><u>MENU</u></h3> 
				<h3><u>Gestion niveau etude</u></h3>
	         ...
	         <a href="search_stu.php">-Recherche</a><br>
				...
				<td align="center" ><h2><marquee>Vous recherchez un etudiant <img src="image/4.gif" width="60px" height="30px" > ?</marquee></h2>
				<div style="overflow:scroll; height:350px; border:#000000 0 solid;" >
					 <?php include "recherche_etudiant.php"; ?>
			 </div>
				</td>
			</tr>
			<tr>

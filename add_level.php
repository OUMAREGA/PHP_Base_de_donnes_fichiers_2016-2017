...
window.onload = function(){ setInterval(textClignotant, 1000); };
			...
			<tr>
	         ...
	         <a href="search_stu.php">-Recherche</a><br>
				...
				<td align="center" ><h2><marquee>Vous pouvez ajouter un niveau d'étude à ce niveau ! <img src="image/1.jpeg" width="30px" height="30px" > </marquee></h2>
				
					 <?php include "form_ajout_etude.php"; ?>	
				</td>
			</tr>
			<tr>

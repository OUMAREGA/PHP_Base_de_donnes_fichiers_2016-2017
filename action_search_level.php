...
window.onload = function(){ setInterval(textClignotant, 1000); };
			...
			<tr>
	         ...
	         <a href="search_stu.php">-Recherche</a><br>
				...
				<td align="center" ><h2><marquee>Modifier et ou supprimer des niveaux d'etudes</marquee></h2>
				<div style="overflow:scroll; height:300px; border:#000000 0px solid; background:#F9F9F9;" >
					 <?php include "action_rechercher_niveau_etude.php"; ?>
			    </div>
				</td>
			</tr>
			<tr>
